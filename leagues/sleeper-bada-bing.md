# Bada Bing — Sleeper Dynasty

- **Platform:** Sleeper
- **League:** Bada Bing
- **Link:** https://sleeper.com/leagues/1394078108436418560
- **League ID:** `1394078108436418560`
- **Draft ID:** `1394078109665366016`
- **Me:** `oreokidronaldo` (roster 11) — **draft slot 7**
- **Type:** Dynasty startup, **1QB**, full PPR
- **Teams:** 12
- **Draft:** 23-round snake

## Starting lineup (9 starters)
`QB, RB, RB, WR, WR, TE, FLEX, FLEX` + 12 bench + taxi/IR

- FLEX = RB/WR/TE (no superflex)
- **Taxi:** 3 slots, 1 year, rookies only (no vets)
- **IR/reserve:** 4 slots
- **Max keepers:** 1
- **Playoffs:** 6 teams, weeks 15–17
- **Waivers:** FAAB $200, waiver day Tuesday
- **Trade deadline:** week 12

## Scoring (full PPR, 4-pt pass TD)

### Passing
- Pass yd: **0.04** (1 pt / 25 yds)
- Pass TD: **4**
- INT: **-1**
- 2PT: **+2**

### Rushing
- Rush yd: **0.1** (1 pt / 10 yds)
- Rush TD: **6**
- 2PT: **+2**

### Receiving
- Reception: **1.0** (full PPR)
- Rec yd: **0.1** (1 pt / 10 yds)
- Rec TD: **6**
- 2PT: **+2**
...
- Fumble lost: **-2**
- Fumble (no loss): 0
- K/DST scoring exists but **no starting slots** → ignore

## Format takeaways
- Full PPR + 2 FLEX → **volume pass-catchers** are king; can start 4 WR.
- 1QB + 4pt pass TD → **QB suppressed**, wait until rounds ~4–6.
- No TE premium → don't reach for TE on scoring alone (scarcity only).
- Pass-catching RBs get a real bump (60–80 pts/yr from receptions).
- -2 fumbles = mild ding on turnover-prone volume backs.

## Draft order (slot → manager)
1. RadekA
2. sedale
3. JJAlvarez
4. JaydoggR
...
- **1.07 Justin Jefferson (WR, MIN):** BPA for format. Chase/JSN/Puka/ARSB
  gone by 6. Chose JJ over Nabers (ACL + rookie-ish QB Jaxson Dart risk) and
